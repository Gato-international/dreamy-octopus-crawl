    ...
    <footer className="border-t border-border/40">
      <div className="container max-w-screen-2xl py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li><Link to="/about" className="text-foreground/60 hover:text-foreground">About Us</Link></li>
            <li><Link to="/blog" className="text-foreground/60 hover:text-foreground">Blog</Link></li>
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li><Link to="/services" className="text-foreground/60 hover:text-foreground">Web Development</Link></li>
            <li><Link to="/services" className="text-foreground/60 hover:text-foreground">App Development</Link></li>
            <li><Link to="/services" className="text-foreground/60 hover:text-foreground">UI/UX Design</Link></li>
          </ul>
        </div>
        <div>
      ...
      <div className="border-t border-border/40 py-6">
        <p className="text-center text-sm text-foreground/60">
          © {new Date().getFullYear()} Innovate Inc. All rights reserved.
        </p>
      </div>
    </footer>
  );
