    ...
    return (
        <main className="overflow-x-hidden">
            <section className="container py-24 sm:py-32">
                <div className="mx-auto max-w-lg text-center lg:mx-0 lg:max-w-full lg:text-left">
                    <h1 className="max-w-2xl text-balance text-5xl md:text-6xl xl:text-7xl">Build 10x Faster with Innovate Inc.</h1>
